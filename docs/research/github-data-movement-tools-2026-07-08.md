...
- Job interface: YAML load definitions are the canonical form for repeatable loads; command flags support one-off loads and can emit a YAML skeleton.
