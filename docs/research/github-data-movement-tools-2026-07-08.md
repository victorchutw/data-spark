...
- Validation: v1 validates schema and load rules before writing, including field presence, type coercion, non-null merge keys, and required fields. Invalid records become rejected records, and a reject threshold can fail the load.
