...
- How non-finite text behaves under a pinned or overridden Float64 schema — stored non-finite value versus a Rejected Record per `CONTEXT.md` — is out of scope here and lands with reject thresholds (#8).
